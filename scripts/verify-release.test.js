...
const expectedTag = 'v0.1.7'
const assets = [
  'latest.json', 'SHA256SUMS',
  'Scan.Repair.Local_0.1.7_aarch64.dmg',
  'Scan.Repair.Local_0.1.7_x64-setup.exe',
  'Scan.Repair.Local_0.1.7_amd64.AppImage',
].map(name => ({ name }))
const manifest = {
  version: '0.1.7', tag: expectedTag, source_sha: expectedSha,
  platforms: {
    macos: { url: `https://github.com/example/repo/releases/download/${expectedTag}/Scan.Repair.Local_0.1.7_aarch64.dmg` },
    windows: { url: `https://github.com/example/repo/releases/download/${expectedTag}/Scan.Repair.Local_0.1.7_x64-setup.exe` },
    linux: { url: `https://github.com/example/repo/releases/download/${expectedTag}/Scan.Repair.Local_0.1.7_amd64.AppImage` },
  },
}
